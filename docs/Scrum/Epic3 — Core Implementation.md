...
**Гейт после эпика:** готовая, тестируемая, работающая реализация UScalar (или выбранного имени) + полный набор юнит-тестов.
...
**Смысл:** реализовать создание UScalar по спецификации Epic 2.
...
### Выходные артефакты
- файл UScalarFactory.cs или статические фабрики в типе
